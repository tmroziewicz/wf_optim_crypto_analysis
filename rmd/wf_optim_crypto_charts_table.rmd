...
ggplot(merged_cumsum_xts) +
  
  geom_line(aes(x = index(merged_cumsum_xts), y = `BTC Train 7 Test 28`, colour = 'BTC Train 7 Test 28'), linetype="solid", alpha=alpha) +
  geom_line(aes(x = index(merged_cumsum_xts), y = `BTC Train 14 Test 10`, colour = 'BTC Train 14 Test 10'),linetype="solid",alpha=alpha) +
  geom_line(aes(x = index(merged_cumsum_xts), y = `ETH Train 7 Test 28`, colour = 'ETH Train 7 Test 28'),linetype="dashed",alpha=alpha) +
  geom_line(aes(x = index(merged_cumsum_xts), y = `ETH Train 14 Test 10`, colour = 'ETH Train 14 Test 10'),linetype="dashed",alpha=alpha) +
  geom_line(aes(x = index(merged_cumsum_xts), y = `Buy And Hold BTC`, colour = 'Buy-And-Hold BTC'),linetype="solid",alpha=alpha+alphaadd ) +
  geom_line(aes(x = index(merged_cumsum_xts), y = `Buy And Hold ETH`, colour = 'Buy-And-Hold ETH'),linetype="dashed",alpha=alpha+alphaadd) +
  
  geom_line(aes(x = index(merged_cumsum_xts), y = `BNB Train 7 Test 28`, colour = 'BNB Train 7 Test 28'),linetype="dotted" ,alpha=alpha) +
  geom_line(aes(x = index(merged_cumsum_xts), y = `BNB Train 14 Test 10`, colour = 'BNB Train 14 Test 10'),linetype="dotted",alpha=alpha) +
geom_line(aes(x = index(merged_cumsum_xts), y = `Buy And Hold BNB`, colour = 'Buy-And-Hold BNB'),linetype="dotted",alpha=alpha+alphaadd ) +
  ...
  coord_trans(y ='log')+
  xlab("Unseen data period") +
  ylab("Cumulative return")  + 
  theme(plot.caption =element_text(hjust = 0, size=6, margin=unit(c(10,0,0,0) , "pt"), lineheight=line_height, family="Times")	)+  
  labs(caption = str_wrap(paste("Note: Equity curves for ", unseen_strategies_desc_str, unseen_test_description_str, " ",transaction_cost_desc_str_fig ),text_note_length))
